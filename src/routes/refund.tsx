...
export const Route = createFileRoute("/refund")({
  head: () => ({
    meta: [
      { title: "Refund & Cancellation Policy — Kavitha Hostel" },
      { name: "description", content: "Refund and cancellation terms for bookings at Kavitha Hostel." },
      { property: "og:title", content: "Refund & Cancellation Policy — Kavitha Hostel" },
