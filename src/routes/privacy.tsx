...
export const Route = createFileRoute("/privacy")({
  head: () => ({
    meta: [
      { title: "Privacy Policy — Kavitha Hostel" },
      { name: "description", content: "How Kavitha Hostel collects, uses and protects your personal information." },
      { property: "og:title", content: "Privacy Policy — Kavitha Hostel" },
